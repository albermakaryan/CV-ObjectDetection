...
class RCNN_Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        height_ratio = 1/old_height
        width_ratio = 1/old_width
        
        
        # ic(new_height,new_width)
        # ic(old_height,old_width)
        # ic(image.size())
        # ic(height_ratio,width_ratio)
        ...
        bbox = torch.tensor([[bbox[0],bbox[1],bbox[0]+bbox[2],bbox[1]+bbox[3]] for bbox in bbox])
